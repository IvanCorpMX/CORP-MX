        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          {agreements.map((agreement, idx) => (
            <motion.div 
              ...
              className="p-8 md:p-10 rounded-2xl border border-corp-black/10 dark:border-white/10 bg-gray-50 dark:bg-neutral-800/50 hover:border-gold-500/50 dark:hover:border-gold-500/50 hover:shadow-md transition-all flex flex-col sm:flex-row gap-6 group items-start"
            >
