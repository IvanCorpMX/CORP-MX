...
export default function Philosophy() {
  return (
    <section id="filosofia" className="py-24 bg-gray-50 dark:bg-neutral-900 relative transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          <h2 className="text-sm font-medium text-gold-500 uppercase tracking-widest mb-3">Identidad Corporativa</h2>
          <h3 className="text-4xl md:text-5xl font-display font-bold text-corp-black dark:text-white">Nuestra Filosofía.</h3>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
          ...
          <motion.div
            ...
            className="md:col-span-6 lg:col-span-4 bg-white dark:bg-neutral-800 border border-corp-black/10 dark:border-white/10 shadow-sm p-10 md:p-12 rounded-2xl hover:border-gold-500/30 dark:hover:border-gold-500/30 hover:shadow-xl hover:shadow-gold-500/10 transition-all group"
          >
            <motion.div 
              whileHover={{ rotate: -15, scale: 1.1 }}
              className="w-14 h-14 rounded-xl bg-gray-50 dark:bg-neutral-900 flex items-center justify-center mb-8 border border-corp-black/5 dark:border-white/5 group-hover:bg-gold-500/10 transition-colors"
            >
              <Eye size={28} className="text-gold-500" />
            </motion.div>
            <h4 className="text-2xl font-display font-bold mb-4 text-corp-black dark:text-white">Visión</h4>
            <p className="text-sm text-corp-black/70 dark:text-white/70 leading-relaxed">
